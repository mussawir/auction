...
class NutritionController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
	 public function testingemailz(){
		 $subject = 'Testing Email';
		 $email = 'hamza@missyjubilee.com';
		 $mail_body = 'Testing emails';
		 $data = [
                    'message'=>  $mail_body, 
                ];
                Mail::send(['html' => 'admin.nutritions.testemailz'], $data, function ($message) use ($email , $subject) {
