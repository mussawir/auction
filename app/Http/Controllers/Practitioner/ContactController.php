...
class ContactController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('practitioner.contact.index')
		->with('meta', $meta)
...
*/
        ...
        if($request->hasFile('photo')) {
            ...
            $file->move(public_path().'/images/practitioners/'.$practitioner_info->url .'/', $filename);
        }
    ...
    public function update(Request $request)
    {
        ...
        if($request->hasFile('photo')) {
            ...
            if (isset($contact->photo) && (!empty($contact->photo))) {
                unlink(public_path().'/images/practitioners/'.$practitioner_info->url .'/'. $contact->photo);
            }
    ...
    public function destroy($id)
    {
        ...
        if(isset($contact)){
            if (isset($contact->photo) && (!empty($contact->photo))) {
                unlink(public_path() . '/images/pratitioners/'.$practitioner_info->url .'/' . $contact->photo);
            }
