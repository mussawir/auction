<?php $__env->startSection('content'); ?>
    ...
    <div class="section-container" id="checkout-info">
        <!-- BEGIN container -->
            <!-- BEGIN checkout -->
            <div class="checkout">
                <?php echo Form::model($info, array('url'=>'/patient/ecommerce/save_shipping', 'method' => 'PATCH', 'class'=> 'form-horizontal', 'files'=>true,'data-parsley-validate' => 'true')); ?>
					...
					<?php if(count($shippingAdd)){ ?>
						<div class="form-group">
							...
							$oppAppend ='';
							?>
								<?php foreach($shippingAdd as $shipping_items): ?>
								<?php 
					...
					<?php } ?>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <?php echo Form::text('first_name', null, array('id'=>'first_name','class'=>'form-control', 'placeholder'=> 'First Name', 'data-parsley-required'=>'true')); ?>
                        ...
                        <!--<div class="form-group">
                            ...
                            <div class="col-md-4">
							{--<?php echo Form::text('last_name', null, array('id'=>'last_name','class'=>'form-control', 'placeholder'=> 'Last Name', 'data-parsley-required'=>'true')); ?> --}
                            </div>
                        </div>-->
                        <div class="form-group">
                            <label class="control-label col-md-4">
                            ...
                            <div class="col-md-4">
                                <?php echo Form::text('zip_code', null, array('id'=>'zip_code','class'=>'form-control', 'placeholder'=> 'Phone', 'data-parsley-required'=>'true')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <?php echo Form::text('Phone', null, array('id'=>'Phone','class'=>'form-control', 'placeholder'=> 'Phone', 'data-parsley-required'=>'true')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <?php echo Form::text('Address', null, array('id'=>'Address','class'=>'form-control', 'placeholder'=> 'Address', 'data-parsley-required'=>'true')); ?>
                    ...
                    <div class="checkout-footer">
                        <a href="<?php echo e(url('/patient/ecommerce/checkout_cart')); ?>" class="btn btn-white btn-lg pull-left">Back</a>
