...
<ol class="breadcrumb pull-right">
    ...
    <li><a href="<?php echo e(url('/practitioner/blog/')); ?>">Blog</a></li>
    <li class="active">New</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Social Post Edit <small></small></h1>
<!-- end page-header -->
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
            ...
            <div class="panel-body">
                <?php echo Form::model($table1, array('url'=>'/practitioner/blog/update', 'method' => 'PATCH', 'class'=> 'form-horizontal', 'files'=>true,'data-parsley-validate' => 'true')); ?>

                <?php echo Form::hidden('post_id'); ?>


                <div class="col-md-12">
                    <div class="form-group">
                      <?php /* <?php echo Form::label('heading','Post Heading*:', array('class'=>'col-md-3 control-label')); ?> */ ?> 
                        <div class="col-md-9">
                         <?php /*  <?php echo Form::text('heading', null, array('class'=>'form-control', 'placeholder'=> 'Post Heading', 'required' => 'required')); ?>*/ ?> 
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <?php echo Form::textarea('contents',$table1->contents, array('class'=>'ckeditor','id'=>'editor1', 'rows'=>'20', 'data-parsley-required'=>'true')); ?>
                ...
                <div class="col-md-12">
                    <?php echo Form::submit('Save & Publish', array('class'=>'btn btn-success pull-right')); ?>
...
<?php $__env->startSection('page-scripts'); ?>
    <script>
        $(document).ready(function() {
            ...
            var roxyFileman = '<?php echo e(asset('public/plugins/fileman_lastest/index.html')); ?>';
