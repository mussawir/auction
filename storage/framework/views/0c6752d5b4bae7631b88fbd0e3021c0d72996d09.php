                ...
                <div class="panel-body">
                    <select class="pull-right" name="category" id="category" class="form-control" onchange="customSearch('data-table',this.value,10)" style="width: 209px; margin-right: 20px; height: 30px; padding: 3px; border: 1px solid #ccc; border-radius: 3px; color: #000;">
                        ...
                        <?php foreach($items as $cat): ?>
                            <option value="<?php echo e($cat->first_name); ?> <?php echo e($cat->last_name); ?>"><?php echo e($cat->first_name); ?> <?php echo e($cat->last_name); ?></option>
                        <?php endforeach; ?>
                    </select>
                            ...
                            <tr id="foreach">
                                <td>
                                    <?php if(isset($item->mainImage) && (!empty($item->mainImage))): ?>
                                        <img src="<?php echo e(asset($item->mainImage)); ?>" alt="<?php echo e($item->products_name); ?>" style="width: 65px;"/>
                                    <?php else: ?>
                                ...
                                <td>
                                    <?php echo e($item->products_name); ?>

                                </td>
                                <td>
                                    <?php echo e($item->supplier_name); ?>

                                </td>
                                <td id="map_<?php echo e($item->products_id); ?>">
                                    <?php echo e($item->map); ?>

                                </td>
                                <td>
                                    <input value="<?php echo e($item->discountP); ?>" type="number" id="discount_<?php echo e($item->products_id); ?>" min="0" max="100" onKeyPress="if(this.value.length==3) return false;" placeholder="%"><input id="btn_dis_<?php echo e($item->products_id); ?>" type="button" value="Save" onclick="setDiscount(<?php echo e($item->products_id); ?>);">
                                    <input value="<?php echo e($item->profitP); ?>" type="hidden" id="profitP_<?php echo e($item->products_id); ?>">
                                    <span id="error_dis_<?php echo e($item->products_id); ?>"></span>
                                </td>
								<td id="discountPrice_<?php echo e($item->products_id); ?>">
                                    <?php
                                ...
                                <td>
                                    <input value="<?php echo e($item->increased_percentage); ?>"  type="number" id="increase_<?php echo e($item->products_id); ?>" min="0" onKeyPress="if(this.value.length==4) return false;" placeholder="%"><input id="btn_inc_<?php echo e($item->products_id); ?>" type="button" value="Save" onclick="increaePrice(<?php echo e($item->products_id); ?>);">
                                    <span id="error_cut_<?php echo e($item->products_id); ?>"></span>
                                </td>
                                <td id="regPrice_<?php echo e($item->products_id); ?>">
                                ...
                                <td>
                                    <a href="<?php echo e(url('/practitioner/product/details/'.$item->products_id)); ?>" class="btn btn-success btn-xs" data-toggle="tooltip" title="View"><i class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
...
<?php $__env->startSection('page-scripts'); ?>
    <script type="text/javascript">
        $(function () {
            ...
            <?php /*$('#data-table_filter').parent('div').after('<div class="col-md-3"> <select class="pull-right" name="category" id="category" class="form-control" onchange="customSearch("data-table",this.value,-1)" style="width: 142px; margin-right: 20px; height: 33px; padding: 5px; border: none; background: #008a8a; color: #fff;"> <option value="">All Suppliers</option> <?php foreach($items as $cat): ?> <option value="<?php echo e($cat->first_name); ?> <?php echo e($cat->last_name); ?>"><?php echo e($cat->first_name); ?> <?php echo e($cat->last_name); ?></option> <?php endforeach; ?> </select> </div>');*/ ?>
        ...
        function setDiscount(id)
        {
...

            {
                ...
                $.ajax({
                    ...
                    async:false,
                    url: '<?php echo e(URL::to('/practitioner/ecommerce/prac_profit')); ?>',
        ...
        function increaePrice(id)
        {
            ...
            }
            {
                ...
                $.ajax({
                    ...
                    async:false,
                    url: '<?php echo e(URL::to('/practitioner/ecommerce/increase_price')); ?>',
                    beforeSend: function (request) {
                        return request.setRequestHeader('X-CSRF-Token', $("meta[name='csrf-token']").attr('content'));
                    },
                    success: function (result) {
