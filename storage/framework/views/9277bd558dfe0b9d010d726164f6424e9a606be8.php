                    ...
                    <div  id="chatHistoryDiv">
                        <table class="table table-hover" id="loaded_practitioner_table">
							...
							<select class="form-control select" id="pra_id">
                                <?php foreach($practitioners as $values): ?>
								<?php 
								...
								?>
                                <option data-image="<?php echo e($picPath); ?>" value="<?php echo e($values->pra_id); ?>"><?php echo e($values->first_name); ?> <?php echo e($values->last_name); ?></option>
                                <?php endforeach; ?>
                            </select>
							</td>
							</tr>
                            ...
                            <?php foreach($messageHistory as $value): ?>
                               <tr id="practitioners" data-grid-id="<?php echo e($value->practitioner_id); ?>">
							   <?php if($counter==0) { $loaded_practitioner= $value->message_history_created_at; } $counter++; ?>
                                   <td id="<?php echo e($value->practitioner_id); ?>">
								   ...
								   $picPath = asset('public/img/no-user.jpg');
									...
									echo $picPath;
								   ?>" /> 
                                      <a   style=" padding-left: 11px ;" href="#"><?php echo e($value->first_name); ?> <?php echo e($value->last_name); ?></a>
									  <span id="counter_<?php echo e($value->practitioner_id); ?>" class="span-counter"><?php echo e($value->message_unseen_counter); ?></span>
                                   </td>
                               </tr>
                            <?php endforeach; ?>
...
function sendMessage()
        {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(URL::to('/patient/index/send-message-ajax')); ?>',
                data: {
        ...
        function loadChats(tr_pra_id,cNew)
        {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(URL::to('/patient/index/view-message-ajax')); ?>',
                data: {
                    pra_id : pra_id,
...
function startWorker() {
    if(typeof(Worker) !== "undefined") {
        if(typeof(w) == "undefined") {
            w = new Worker("<?php echo e(asset('public/js/webworker.js')); ?>");
