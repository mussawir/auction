                                                                            ...
                                                                            <div class="checkbox">
                                                                                <label>
                                                                                    <input type="checkbox"  data-parsley-required="true"
                                                                                           name="sup_id[]" value="<?php echo e($item->user_id); ?>" <?php echo e(in_array($item->user_id, $pat_ids)? 'checked="checked"' : ''); ?>>
                                                                                </label>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
                                                    ...
                                                    <div class="panel-body">
                                                        <table id="selected-table" class="table table-striped table-hover">
                                                            ...
                                                            <tbody>
                                                            <?php foreach($selected_pat as $item): ?>
                                                                <tr id="<?php echo e($item->user_id); ?>">
                                                                    <td><?php echo e($item->first_name. " ". $item->last_name); ?></td>
                                                                    <td><?php echo e($item->email); ?></td>
                                                                    <td>
                                                                        <?php /*<input type="hidden" name="sup_id[]" value="<?php echo e($item->sup_id); ?>" />*/ ?>
                                                                        <a href="javascript:void(0);" class="text-danger" onclick="removeSupRow(this, '<?php echo e($item->user_id); ?>')"><i class="fa fa-times"></i> Remove</a>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; ?>
                                                            </tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="checkbox">
                                                                                <label>
                                                                                    <input type="checkbox"  data-parsley-required="true"
                                                                                           name="cnt_id[]" value="<?php echo e($item->cnt_id); ?>" <?php echo e(in_array($item->cnt_id, $cnt_ids)? 'checked="checked"' : ''); ?>>
                                                                                </label>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
                                                    ...
                                                    <div class="panel-body">
                                                        <table id="selected-contact-table" class="table table-striped table-hover">
                                                            ...
                                                            <tbody>
                                                            <?php foreach($selected_cont as $item): ?>
                                                                <tr id="<?php echo e($item->cnt_id); ?>">
                                                                    <td><?php echo e($item->first_name. " ". $item->last_name); ?></td>
                                                                    <td><?php echo e($item->email); ?></td>
                                                                    <td>
                                                                        <?php /*<input type="hidden" name="sup_id[]" value="<?php echo e($item->sup_id); ?>" />*/ ?>
                                                                        <a href="javascript:void(0);" class="text-danger" onclick="removeSupRowCont(this, '<?php echo e($item->cnt_id); ?>')"><i class="fa fa-times"></i> Remove</a>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; ?>
                                                            </tbody>
...
<?php $__env->startSection('page-scripts'); ?>
    <script type="text/javascript">
        ...
        function removeSupRow(elm, id) {
            $.get("<?php echo e(url('/practitioner/email-group/removePatients')); ?>", { user_id: id }, function(data) {
        ...
        function removeSupRowCont(elm, id) {
            $.get("<?php echo e(url('/practitioner/email-group/removeContacts')); ?>", { user_id: id }, function(data) {
                $('#page-loader').removeClass('hide');
                if(data == 'success') {
                    $(elm).closest('tr').remove();
...
function addPatientsList()
{
    ...
    $.ajax({
        type: "POST",
        data: form_data,
        url: '<?php echo e(URL::to('/practitioner/email-group/addPatientsWizz')); ?>',
...
function addContactsList()
{
    ...
    $.ajax({
        type: "POST",
        data: form_data,
        url: '<?php echo e(URL::to('/practitioner/email-group/addContactsWizz')); ?>',
        beforeSend: function (request) {
            return request.setRequestHeader('X-CSRF-Token', $("meta[name='csrf-token']").attr('content'));
        },
        success: function (result) {
        ...
        function saveDetail()
        {
            ...
            $.ajax({
                type: "POST",
                data: form_data,
                url: '<?php echo e(URL::to('/practitioner/email-group/to-contact-wiz')); ?>',
                beforeSend: function (request) {
                    return request.setRequestHeader('X-CSRF-Token', $("meta[name='csrf-token']").attr('content'));
                },
                success: function (result) {
        ...
        function saveGroup()
        {
            ...
            $.ajax({
                type: "POST",
                data: form_data,
                url: '<?php echo e(URL::to('/practitioner/email-group/save-group-wiz')); ?>',
                beforeSend: function (request) {
                    return request.setRequestHeader('X-CSRF-Token', $("meta[name='csrf-token']").attr('content'));
                },
                success: function (result) {
                    ...
                    var url = '<?php echo e(URL::to('/practitioner/emails/new?cg_id=')); ?>'+_data[1];
