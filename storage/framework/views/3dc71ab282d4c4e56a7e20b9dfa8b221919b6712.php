                ...
                <table id="dt_list" class="table table-striped table-hover">
                    ...
                    <?php foreach($list as $item): ?>
                        <tr>
                            ...
                            <td><?php echo e($item->sent_to); ?></td>
                            <td>
                                <button type="button" class="btn btn-sm btn-info" onclick="window.location.href='<?php echo e(url('/practitioner/emails/sent_list_details/'.$item->pe_id)); ?>'">View</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
