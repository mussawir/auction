                    ...
                    <div  id="chatHistoryDiv">
                        <table class="table table-hover" id="loaded_practitioner_table">
							...
							<select class="form-control js-example-basic-single"  name='standard' id="pra_id">
                                <?php foreach($patient as $values): ?>
                                <option value="<?php echo e($values->pa_id); ?>"  style="background-image:url(https://upload.wikimedia.org/wikipedia/commons/f/f9/Phoenicopterus_ruber_in_S%C3%A3o_Paulo_Zoo.jpg;">
								<?php echo e($values->first_name); ?>

								<?php echo e($values->last_name); ?></option>
                                <?php endforeach; ?>
                            </select>
							</td>
							</tr>
							<?php $counter = 0; $loaded_practitioner=''; ?>
                            <?php foreach($messageHistory as $value): ?>
                               <tr id="practitioners" data-grid-id="<?php echo e($value->patient_id); ?>">
							   <?php if($counter==0) { $loaded_practitioner= $value->message_history_created_at; } $counter++; ?>
                                   <td  id="<?php echo e($value->patient_id); ?>">
								   ...
								   $picPath = asset('public/img/no-user.jpg');
									...
									echo $picPath;
								   ?>" />
                                      <a  style=" padding-left: 11px ;" style=" padding-left: 11px ;"  href="#"><?php echo e($value->first_name); ?> <?php echo e($value->last_name); ?></a>
									  <span id="counter_<?php echo e($value->patient_id); ?>" class="span-counter"><?php echo e($value->message_unseen_counter); ?></span>
                                   </td>
                               </tr>
                            <?php endforeach; ?>
...
<?php $__env->startSection('page-scripts'); ?>
    ...
    if(code==13){
		...
		function sendMessage()
        {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(URL::to('/practitioner/send-message-ajax')); ?>',
                data: {
  ...
  loadChats(this.value,false);
	...
	$( document ).ready(function() {
        ...
        {   
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(URL::to('/practitioner/view-message-ajax')); ?>',
                data: {
                     pa_id : pa_id,
    ...
    if(typeof(Worker) !== "undefined") {
        if(typeof(w) == "undefined") {
            w = new Worker("<?php echo e(asset('public/js/practitionerBackgroundWorker.js')); ?>");
