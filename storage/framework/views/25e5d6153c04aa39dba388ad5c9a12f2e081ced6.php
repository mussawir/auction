    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
            ...
            <div class="panel-body">
                <?php echo Form::open(array('url'=>'/practitioner/ecommerce/save-store-name', 'class'=> 'form-horizontal', 'files'=>true,'data-parsley-validate' => 'true' , 'id'=>'formid')); ?>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <?php echo Form::label('templates','Customer Store Name : ', array('class'=>'col-md-3 control-label')); ?>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <?php echo Form::label('templates','Customer Store Image : ', array('class'=>'col-md-3 control-label')); ?>

                        <div class="col-md-4">
                          

						  <?php echo Form::file('logo_image', array('onchange'=>'readURL(this,\'imgId\')','class'=>'form-control', 'accept'=>'image/*', 'id'=>'file')); ?>
				  ...
				  <div class="col-md-12">
                    <div class="form-group">
					      <?php echo Form::label('templates',' Store Image Preview : ', array('class'=>'col-md-3 control-label')); ?>
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <?php echo Form::submit('Set Store', array('class'=>'btn btn-success')); ?>

                    <?php if($btnShow=='show') { ?>
                    <?php echo Form::button('Delete Last Defined', array('class'=>'btn btn-danger' , 'onclick'=>'redirectDelete();')); ?>
