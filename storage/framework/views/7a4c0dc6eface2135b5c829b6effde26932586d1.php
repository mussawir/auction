    ...
    <div class="footer-left">
        <div class="inside">
            <div class="footer-main-menu text-center">
                <a href="#">
					<img src="https://www.practicetab.com/dev/public/img/logoWhite.png"" alt="logo" style="width: 100%;"/>
				</a>
                <div class="social">
            ...
            <div class="footer-right-social">
                <ul>
                    <li>
                        <h3>Practitioners</h3>
                        <ul class="inner-list">
                            <li><a href="<?php echo e(url('users/practitioner/login')); ?>">Login</a></li>
                            <li><a href="<?php echo e(url('pricing')); ?>">Register</a></li>
                            <li><a href="#">Referral Program</a></li>
                            <li><a href="#">Terms of Use</a></li>
                            <li><a href="<?php echo e(url('info/privacy-policy')); ?>" target="_blank">Merchandise, Refund, Privacy &amp; Security Policies</a></li>
                    ...
                    <li>
                        <h3>Contacts</h3>
                        <ul class="inner-list">
                            <li><a href="<?php echo e(url('users/patient/login')); ?>">Login</a></li>
