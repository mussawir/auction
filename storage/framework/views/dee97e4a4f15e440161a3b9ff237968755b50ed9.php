...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Blog Post Edit <small></small></h1>
<!-- end page-header -->
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <?php echo Form::label('heading','Post Heading*:', array('class'=>'col-md-3 control-label')); ?>

                        <div class="col-md-9">
                            <?php echo Form::text('heading', null, array('class'=>'form-control', 'placeholder'=> 'Post Heading', 'required' => 'required')); ?>
