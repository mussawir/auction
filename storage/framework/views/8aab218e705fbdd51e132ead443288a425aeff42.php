...
<head>
    ...
    <link href="<?php echo e(asset('public/css/theme/default.css')); ?>" rel="stylesheet" id="theme" />
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    <!-- begin #header -->
    <?php echo $__env->make('practitioner.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <!-- end #header -->
    <!-- begin #sidebar -->
...
<script src="<?php echo e(asset('public/plugins/jquery/jquery-migrate-1.1.0.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/plugins/jquery-ui/ui/minified/jquery-ui.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/plugins/bootstrap/js/bootstrap.min.js')); ?>"></script>
<!--[if lt IE 9]>
<script src="<?php echo e(asset('public/dashboard/crossbrowserjs/html5shiv.js')); ?>"></script>
<script src="<?php echo e(asset('public/dashboard/crossbrowserjs/respond.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/dashboard/crossbrowserjs/excanvas.min.js')); ?>"></script>
<![endif]-->
<script src="<?php echo e(asset('public/plugins/slimscroll/jquery.slimscroll.min.js')); ?>"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.min.js"></script>

<script src="<?php echo e(asset('public/plugins/jquery-cookie/jquery.cookie.js')); ?>"></script>
<!-- ================== END BASE JS ================== -->
...
<script type="text/javascript" src="<?php echo e(asset('public/plugins/ckeditor/ckeditor.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/plugins/bootstrap-wysihtml5/lib/js/wysihtml5-0.3.0.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/plugins/bootstrap-wysihtml5/src/bootstrap-wysihtml5.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/js/form-wysiwyg.demo.min.js')); ?>"></script>
...
data : {
role : 'practitioner',
path : <?php echo e(Auth::user()->user_id); ?>

},
async:false,
//url     : '/patient/index/shipping_save,
url: '<?php echo e(URL::to('/public/plugins/fileman_lastest/php/setSessionPublic.php')); ?>',
beforeSend: function (request) {
return request.setRequestHeader('X-CSRF-Token', $("meta[name='csrf-token']").attr('content'));
},
success: function (result) {
