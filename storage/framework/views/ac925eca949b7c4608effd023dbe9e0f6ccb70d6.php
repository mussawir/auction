    ...
    <div class="panel-body">
        <div data-scrollbar="true" data-height="300px">
            <table id="exercise-data-table" class="table table-striped table-hover">
                ...
                <tbody>
                <?php foreach($nut_sug_master as $item): ?>
                    <tr>
                        <td><?php echo e(date('m/d/Y H:i:s', strtotime($item->created_at))); ?></td>
                        <td><?php echo e($item->pra_fullname); ?></td>
                        <td><?php echo e($item->message); ?></td>
                        <td>
                            <button type="button" class="btn btn-sm btn-info" onclick="window.location.href='<?php echo e(url('/patient/index/nutrition-suggestion-details/'.$item->id)); ?>'">View</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
