            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="product-image">
							...
							<?php if(isset($item->image_path) && $item->image_path!="") { ?>
                                <li>
                                    <a href="#" data-click="show-main-image" data-url="<?php echo e(asset($item->image_path)); ?>">
                                        <img class="img-responsive" src="<?php echo e(asset($item->image_path)); ?>" alt="<?php echo e($product->products_name); ?>"/>
                                    </a>
                                </li>
							<?php } ?>
                                <?php endforeach; ?>
                        ...
                        <div class="product-main-image" data-id="main-image">
                            <img src="<?php echo e(asset($product->mainImage)); ?>" alt="" />
                        </div>
						<?php } ?>
                ...
                <div class="col-md-6" style="padding: 20px 30px;margin-bottom: 20px;">
                    ...
                    <div class="product-info-header">
						...
						<?php 			
if(isset($product->discountPer)){						
									if((int)$product->discountPer > 0 ){ ?>
						<span class="label label-success">
								...
								?>
						 <?php echo e($product->products_name); ?> </h1>
                    ...
                    <?php else: ?>
                        ...
                        <ul class="product-info-list">
							...
							<?php /*<li><i class="fa fa-circle"></i><strong>Category: </strong><?php echo e($product->cat_name); ?></li>*/ ?>
							...
							<li><i class="fa fa-circle"></i><strong>Supplier Name:</strong>
							<?php echo e($product->first_name); ?> <?php echo e($product->last_name); ?>

                            </li>
							 <li><i class="fa fa-circle"></i><strong>Practitioner Store: </strong><?php echo e($product->value); ?></li>
                        </ul>
                        <?php echo Form::open(array('url'=>'/patient/ecommerce/cart', 'class'=> 'form-horizontal', 'files'=>true, 'data-parsley-validate' => 'true')); ?>

                        <input type="hidden" value="<?php echo e($product->products_id); ?>" name="products_id" id="products_id">
                        <input type="hidden" value="<?php echo e($store_id); ?>" name="store_id" id="store_id">
                            <div class="form-group">
                                <?php echo Form::label('quantity','Quantity *:', array('class'=>' control-label','style'=>'margin:5px 14px;')); ?>

                                <?php echo Form::number('quantity', '1', array('class'=>'form-control', 'data-parsley-required'=>'true', 'style'=>'width:60px;margin:0 14px;','min'=>'1')); ?>

                            </div>
                        <div class="product-purchase-container">
						<?php $amount = round($product->pra_price, 2);
									?>
						<?php	
								if($amount < $product->map){ ?>
                            <div class="product-discount">
                                <span class="discount">$<?php echo e($product->map); ?></span>
                            </div>
                            <div class="product-price">
                                <div class="price"> $<?php echo e($amount); ?></div>
                            </div>
							<?php
								}else{ ?>
								 <div class="product-price">
								...
								?>
                            <?php echo Form::submit('ADD TO CART', array('class'=>'btn btn-inverse btn-lg')); ?>
