    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
            ...
            <div class="panel-body">
                <?php echo Form::open(array('url'=>'/practitioner/blog/store', 'class'=> 'form-horizontal', 'files'=>true,'data-parsley-validate' => 'true')); ?>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?php echo Form::text('heading', null, array('class'=>'form-control', 'placeholder'=> 'Post Heading', 'data-parsley-required'=>'true')); ?>

                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <?php echo Form::textarea('contents', '<h1>Write a great post today!</h1>', array('class'=>'ckeditor','id'=>'editor1', 'rows'=>'20', 'data-parsley-required'=>'true')); ?>
