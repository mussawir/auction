<?php $__env->startSection('content'); ?>
	...
	<a class="btn btn-success pull-right" href="<?php echo e(url('/patient/ecommerce/stores-list')); ?>" style="margin: 3px 12px;">Add New Stores</a>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
                                    ...
                                    <div class="row">
                                        <div class="item-info">
                                            <div class="col-md-3" style="margin-bottom:10px;">
                                                ...
                                                <a href="<?php echo e(url('/patient/ecommerce/store/products/'.$item->pra_id)); ?>" class="btn btn-success btn-block" style="background-color: #00ACAC;    width: 172px;
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo Form::text('request_msg', null, array('class'=>'form-control', 'placeholder'=> 'Enter your request', 'data-parsley-required'=>'true')); ?>
