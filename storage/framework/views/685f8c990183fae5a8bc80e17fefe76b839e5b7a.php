...
<head>
	...
	<title><?php echo e(isset($meta['page_title'])?$meta['page_title'].' - ':''); ?>Practice Tabs</title>
    ...
    <link href="<?php echo e(asset('public/css/cart.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(asset('public/plugins/fullcalendar/fullcalendar.print.css')); ?>" rel="stylesheet" media='print' />
    <link href="<?php echo e(asset('public/plugins/fullcalendar/fullcalendar.min.css')); ?>" rel="stylesheet" />
    ...
    <link href="<?php echo e(asset('public/css/PopupBox.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('public/css/jquery.ui.autocomplete.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('public/css/bwizard.min.css')); ?>" rel="stylesheet" />
    ...
    <!-- ================== BEGIN BASE JS ================== -->
    <script src="<?php echo e(asset('public/plugins/fullcalendar/lib/moment.min.js')); ?>"></script>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="header" class="header navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <?php /*<ul class="nav navbar-nav">*/ ?>
                    <?php /*<li>*/ ?>
                        <?php /*<a href="<?php echo e(url('patient/ecommerce')); ?>">*/ ?>
                            <?php /*<button class="btn btn-info">*/ ?>
                                <?php /*<span class="fa fa-shopping-cart" aria-hidden="true"></span>*/ ?>
                                <?php /*Ecommerce*/ ?>
                            <?php /*</button>*/ ?>
                        <?php /*</a>*/ ?>
                    <?php /*</li>*/ ?>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li style="display:none">
                    <?php echo Form::open(array('url'=>'/patient/ecommerce/order-tracking', 'class'=> 'navbar-form full-width', 'data-parsley-validate' => 'true')); ?>
                ...
                <li class="dropdown">
                    ...
                    <a href="#" class="header-cart" data-toggle="dropdown" style="padding: 14px 0px;">
                        ...
                        <span id="cart-counter" class="total"><?php echo e(count($cart)); ?></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-cart p-0">
                                    ...
                                    <ul class="cart-item"style="overflow-y: auto;max-height: 300px;">
                                        <?php if(count($cart)): ?>
                                            <?php foreach($cart as $key=>$val): ?>
                                                <li id="cart-item-<?php echo e($val->products_id); ?>">
                                                    <div class="cart-item-image">
                                                        <?php if(isset($val->mainImage) && (!empty($val->mainImage))): ?>
                                                            <img src="<?php echo e(asset($val->mainImage)); ?>" alt="<?php echo e($val->products_name); ?>"/>
                                                        <?php else: ?>
                                                            <img src="<?php echo e(asset('public/img/no_image_64x64.jpg')); ?>" alt="<?php echo e($val->products_name); ?>" />
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="cart-item-info">
                                                        <strong><p>Product</p></strong>
                                                        <strong><?php echo e($val->products_name); ?></strong>
                                                    </div>
                                                    <div class="cart-item-price">
                                                        <strong><p>Qty</p></strong>
                                                        <span id="cart-item-qty-<?php echo e($val->products_id); ?>"><?php echo e($val->qty); ?>

														</span>
                                                    </div>
                                                    <div class="cart-item-close">
                                                        <a onclick="removeCart('<?php echo e($val->cart_id); ?>','<?php echo e($val->products_id); ?>');" href="#" data-title="Remove">&times;</a>
                                                    </div>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                ...
                                <div class="cart-footer">
                                    <div class="row row-space-10">
                                        <div class="col-xs-6">
                                            <a href="<?php echo e(url('/patient/ecommerce/checkout_cart')); ?>" class="btn btn-default btn-block" style="background: #00acac;">View Cart</a>
                                        </div>
                                        <?php if(count($cart)): ?>
                                            <div class="col-xs-6">
                                                <a href="<?php echo e(url('/patient/ecommerce/checkout_info')); ?>"  class="btn btn-inverse btn-block" >Checkout</a>
                                            </div>
                                        <?php else: ?>
                                            <div class="col-xs-6">
                                                <a href="<?php echo e(url('/patient/ecommerce/checkout_info')); ?>" class="btn btn-inverse btn-block">Checkout</a>
                ...
                <!--<li class="dropdown">
                    ...
                    <li class="media">
                        <a href="javascript:;">
                            <div class="media-left"><img src="<?php echo e(url('public/dashboard/img/user-1.jpg')); ?>" class="media-object" alt="" /></div>
                            <div class="media-body">
                    ...
                    <li class="media">
                        <a href="javascript:;">
                            <div class="media-left"><img src="<?php echo e(url('public/dashboard/img/user-2.jpg')); ?>" class="media-object" alt="" /></div>
                            <div class="media-body">
                ...
                <li class="dropdown navbar-user">
                    ...
                    <ul class="dropdown-menu animated fadeInLeft">
                        ...
                        <li><a href="<?php echo e(url('/patient/index/change-password')); ?>">Change Password</a></li>
                        <li class="divider"></li>
    ...
    <div id="sidebar" class="sidebar">
        ...
        <div data-scrollbar="true" data-height="100%">
           ...
           <?php echo $__env->make('patient.patient-menu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <!-- end sidebar nav -->
        </div>
...
<script type="text/javascript" src="<?php echo e(asset('public/js/bwizard.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/js/form-wizards-validation.demo.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/js/form-wizards.demo.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/js/apps.js')); ?>"></script>


<!-- ================== END PAGE LEVEL JS ================== -->
<script src="<?php echo e(asset('public/plugins/fullcalendar/fullcalendar.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/plugins/fullcalendar/fullcalendar.js')); ?>"></script>
<script src="<?php echo e(asset('public/plugins/popup/jquery.bpopup.js')); ?>"></script>
<script src="<?php echo e(asset('public//js/calendar.demo.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/plugins/datepicker/form-plugins.demo.min.js')); ?>"></script>

<script src="<?php echo e(asset('public/plugins/Autocomplete/jquery.ui.autocomplete.min.js')); ?>"></script>
...
function isReadNotification()
{
	...
	//var q = confirm("Are you sure you want to delete this contact group?");
            //if (q == true) {
                ...
                $.ajax({
                    type: "GET",
                    url: '<?php echo e(URL::to('/notification/public/read')); ?>',
        ...
        function AddProduct()
        {
			...
			if(quantity>0)
            {
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(URL::to('/patient/ecommerce/add-cart-product')); ?>',
                    beforeSend: function (request) {
                        return request.setRequestHeader('X-CSRF-Token', $("meta[name='csrf-token']").attr('content'));
                    },
                    success: function (result) {
