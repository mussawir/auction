							...
							<?php if(isset($item->image_path) && $item->image_path!="") { ?>
                                <li>
                                    <a href="#" data-click="show-main-image" data-url="{{asset($item->image_path)}}">
                                        <img class="img-responsive" src="{{asset($item->image_path)}}" alt="{{$product->products_name}}"/>
                                    </a>
                                </li>
							<?php } ?>
                                @endforeach
                    ...
                    @else
                        ...
                        <ul class="product-info-list">
							...
							{{ $product->first_name }} {{ $product->last_name }}
							 ...
							 <li><i class="fa fa-circle"></i><strong>Practitioner Store: </strong>{{ $product->value }}</li>
                        </ul>
						...
						<?php	
                            ...
                            <div class="product-discount">
                                <span class="discount">${{ $product->map }}</span>
                            </div>
