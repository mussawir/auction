                        ...
                        <div class="col-md-6"  id="border-right">
                            ...
                            <div class="row">
                                ...
                                <button onclick="sendMessage();" type="button" class="btn btn-sm btn-primary m-r-5">Send</button>
                                    <img src="/dev/public/img/transparent/ajax-loader.gif" id="ajaxloaderImg" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <p align="center" id="chatLoadingImage">  <img height="50px" width="50px" src="/dev/public/img/transparent/ajax-loader.gif" />
                            </p>
