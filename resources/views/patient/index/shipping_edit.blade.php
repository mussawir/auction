...
<?php 
	...
	if($type == '1' || $type == '2' ){
	  ...
	  <ol class="breadcrumb pull-right">
        ...
        <li class="active"><?php echo $str1;?></li>
		</ol>
	<?php }	?>
    ...
    <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Edit <?php echo $str1," ",$str2 ;?> </h4>
        </div>
        <div class="panel-body">
            {!! Form::model($shipping_list, array('url'=>'/patient/index/shipping_save', 'class'=> 'form-horizontal', 'files'=>true, 'data-parsley-validate' => 'true')) !!}
