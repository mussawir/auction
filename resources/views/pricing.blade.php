                ...
                <div  class="inner">
                    <div class="freeProfile">
                        ...
                        <ul>
                            ...
                            <li class="listCross"><span class="listX"></span>Contact Management</li>
                            ...
                            <li class="listCross"><span class="listX"></span>Secure Contact Portal</li>
                        </ul>
                    ...
                    <div class="premiumProfile">
                        ...
                        <ul>
                            ...
                            <li class="listCheck"><span class="listY"></span>Contact Management</li>
                            ...
                            <li class="listCheck"><span class="listY"></span>Secure Contact Portal</li>
                        </ul>
