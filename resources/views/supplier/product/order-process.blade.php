...
<!-- end page-header -->
    ...
    <div class="row">
        ...
        <!-- end col 6 -->
				...
				{!! Form::open(array('url'=>'/supplier/orders/process/save', 'method'=>'post' , 'class'=> 'form-horizontal', 'files'=>true,'data-parsley-validate' => 'true')) !!}
									<div class="modal-body" id="order-detail-model">
									
									</div>
									<div class="modal-footer">
									<input type="hidden" id="m_order_id_curr"  name="m_order_id_curr" value="0" />
									<?php  $val = "";
									$name = "";
									$m_id_id;
										...
										elseif($page == 'order_list_4')
										{
											$name = 'Deliver';
											$val = '1';
										}
									?>
										<button  type="submit" class="btn btn-success"><?php echo $name;?></button>
...
@section('page-scripts')
    ...
    <script type="text/javascript">
		...
		function showDetail(id){
			...
			type    : 'GET',
			async:false,
			url: '{{ URL::to('/supplier/ordershipped')}}'+'/'+id,
