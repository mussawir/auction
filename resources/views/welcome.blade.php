            ...
            <div id="main-carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner"> 
                    ...
                    <div class="item active">
                        <img src="{{asset('public/theme/img/slider-1-cover.jpg')}}" class="bg-cover-img" alt="" />
                        <div class="container">
                            <img src="{{asset('public/theme/img/slider-1-product.png')}}" class="product-img right bottom fadeInRight animated" alt="" />
                        </div>
                    ...
                    <!-- BEGIN item -->
                    <div class="item">
                        <img src="theme/img/slider-2-cover.jpg" class="bg-cover-img" alt="" />
                        <div class="container">
                            <img src="{{asset('public/theme/img/slider-2-product.png')}}" class="product-img left bottom fadeInLeft animated" alt="" />
                        </div>
                    ...
                    <!-- BEGIN item -->
                    <div class="item">
                        <img src="{{asset('public/theme/img/slider-3-cover.jpg')}}" class="bg-cover-img" alt="" />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="promotion promotion-lg bg-black-darker">
                            <div class="promotion-image text-right promotion-image-overflow-bottom">
                                <img src="{{asset('public/theme/img/iphone-se.png')}}" alt="" />
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="promotion bg-blue">
                            <div class="promotion-image promotion-image-overflow-bottom promotion-image-overflow-top">
                                <img src="{{asset('public/theme/img/apple-watch-sm.png')}}" alt="" />
                            </div>
                        ...
                        <div class="promotion bg-silver">
                            <div class="promotion-image text-center promotion-image-overflow-bottom">
                                <img src="{{asset('public/public/theme/img/mac-mini.png')}}" alt="" />
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="promotion bg-silver">
                            <div class="promotion-image promotion-image-overflow-right promotion-image-overflow-bottom text-right">
                                <img src="{{asset('public/theme/img/mac-accessories.png')}}" alt="" />
                            </div>
                            <div class="promotion-caption text-center">
                        ...
                        <div class="promotion bg-black">
                            <div class="promotion-image text-right">
                                <img src="{{asset('public/theme/img/mac-pro.png')}}" alt="" />
                            </div>
                            <div class="promotion-caption promotion-caption-inverse">
            ...
            <div class="container">
                ...
                <div class="row row-space-10">
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="{{asset('public/theme/img/iphone.png')}}" alt="" />
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="{{asset('public/theme/img/ipad-pro.png')}}" alt=""  />
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="{{asset('public/theme/img/imac.png')}}" alt="" />
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="{{asset('public/theme/img/apple-watch.png')}}" alt="" />
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="{{asset('public/theme/img/macbook-pro.png')}}" alt="" />
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="{{asset('public/theme/img/apple-tv.png')}}" alt="" />
                    ...
                    <div class="category-detail">
                        ...
                        <a href="#" class="category-item full">
                            <div class="item">
                                <div class="item-cover">
                                    <img src="{{asset('public/theme/img/samsung-s7-edge.jpg')}}" alt="" />
                                </div>
                        ...
                        <div class="category-item list">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="{{asset('public/theme/img/samsung-note5.png')}}" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="{{asset('public/theme/img/zenfone2.png')}}" alt="" />
                                        <div class="discount">15% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="{{asset('public/theme/img/xperia-z.png')}}" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="{{asset('public/theme/img/lumia-532.png')}}" alt="" />
                                        <div class="discount">20% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                ...
                <div class="category-container">
                    ...
                    <div class="category-detail">
                        ...
                        <a href="#" class="category-item full">
                            <div class="item">
                                <div class="item-cover">
                                    <img src="{{asset('public/theme/img/huawei-mediapad.jpg')}}" alt="" />
                                </div>
                                <div class="item-info bottom">
                        ...
                        <div class="category-item list">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="{{asset('public/theme/img/galaxy-tab2.png')}}" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="{{asset('public/theme/img/galaxy-taba.png')}}" alt="" />
                                        <div class="discount">20% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="{{asset('public/theme/img/hp-spectrex2.png')}}" alt="" />
                                        <div class="discount">15% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="{{asset('public/theme/img/xperia-z2.png')}}" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="{{asset('public/theme/img/ipad-air.png')}}" alt="" />
                                        <div class="discount">20% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
