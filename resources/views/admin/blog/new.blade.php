...
<ol class="breadcrumb pull-right">
    ...
    <li class="active">Contact Dashboard New</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Contact Dashboard <small>Create New Contact Dashboard Post</small></h1>
<!-- end page-header -->
...
<div class="row">
    ...
    {!! Form::open(array('url'=>'/admin/adminBlog/store', 'id'=>'frm-contact', 'class'=> 'form-horizontal', 'files'=>true,'data-parsley-validate' => 'true'
)) !!}
    <!-- begin col-8 -->
    <div class="col-md-12">
        <!-- begin panel -->
        <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Create New Contact Dashboard Post</h4>
            </div>
