...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header pull-left">Users <small></small></h1>
<a href="{{url('/admin/index/new-user')}}" class="btn btn-success pull-right" style="margin-right: 15px;">Add New User</a>
<!-- end page-header -->
<!-- begin row -->
<div class="row">
    <!-- begin col-6 -->
