                    ...
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a data-toggle="tooltip" title="Block" id="block_{{$item->pra_id}}"  onclick="doDelete('{{$item->pra_id}}', 'block');" href="javascript:void(0);" class="btn btn-danger" ><i class="fa fa-lock"></i></a>
                            <?php } else { ?>
                                <a id="unblock_{{$item->pra_id}}" data-toggle="tooltip" title="Unblock"  onclick="doDelete('{{$item->pra_id}}', 'unblock');" href="javascript:void(0);" class="btn btn-success" ><i class="fa fa-unlock"></i> </a>
                                <?php } ?>
                                <a data-toggle="tooltip" title="View" href="{{url('admin/index/practitioner')}}/{{$item->pra_id}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
