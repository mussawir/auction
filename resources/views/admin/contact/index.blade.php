...
<a href="{{url('/admin/contact/new')}}" class="btn btn-success pull-right" style="margin-right: 15px;border-radius:0;"><i class="fa fa-plus"></i> Add Contact</a>
<!-- end breadcrumb -->
<!-- begin page-header -->
                ...
                <table id="data-table" class="table table-striped table-hover">
                    ...
                    @foreach($contact_list as $item)
                        <tr>
                            ...
                            <td>{{$item->address}}</td>
                            <td>
                                <a  style="margin-bottom: 2px"; data-toggle="tooltip" title="Edit" class="btn btn-success" href="{{url('/admin/contact/edit/'.$item->cnt_id)}}"><i class="fa fa-pencil"></i></a>    
                                <a data-toggle="tooltip"  title="Delete" class="btn btn-danger" href="javascript:void(0);" onclick="doDelete('{{$item->cnt_id}}', this);"><i class="fa fa-trash-o"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
