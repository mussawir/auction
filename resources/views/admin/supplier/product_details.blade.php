...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Suppliers Product's Details <small></small></h1>
<!-- end page-header -->
<!-- begin row -->
<div class="row">
    <!-- begin col-6 -->
                                    ...
                                    <div class="product-thumbnail">
										...
										<?php if(isset($images)){ ?>
                                            @foreach($images as $item)
                                                <li>
                                                    <a onclick="handleThumb(this);" href="#" data-click="show-main-image" data-url="{{asset($item->image_path)}}">
										...
										<?php } ?>
										<li class="active">
										<a onclick="handleThumb(this);" href="#" data-click="show-main-image" data-url="{{asset($product->mainImage)}}">
                                ...
                                @else
                                    ...
                                    <ul class="product-info-list">
                                        ...
                                        <li><i class="fa fa-circle"></i><strong>Total Products Quantity:</strong> {{ $product->quantity }}</li>
											{{--<li><i class="fa fa-circle"></i><strong>Category: </strong>{{ $product->cat_name }}</li>--}}
...
function handleThumb(obj){
	$('.product-thumbnail-list').children('li').removeClass('active');
	$(obj).parent().addClass('active');
	var url = $(obj).data('url');
	$('.product-main-image').children('img').attr('src',url);
}
    </script>
@endsection