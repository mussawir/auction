                ...
                <table id="dt_list" class="table table-striped table-hover">
                    ...
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td>
                              <!--  <button class="fa fa-eye" type="button" class="btn btn-success" onclick="window.location.href='{{url('/admin/emails/sent_list_details/'.$item->ae_id)}}'"></button>-->
                         <a data-toggle="tooltip" title="View" class="btn btn-success" href="{{url('/admin/emails/sent_list_details/'.$item->ae_id)}}" ><span class="fa fa-eye" ></a>
