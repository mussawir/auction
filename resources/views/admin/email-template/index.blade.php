...
<a href="http://practicetab.com/dev/admin/email-templates/new" class="btn btn-success pull-right" style="margin-right: 15px;border-radius:0;"><i class="fa fa-plus"></i> Add New Template</a>
<!-- end breadcrumb -->
<!-- begin page-header -->
                ...
                <table id="data-table" class="table table-striped table-hover">
                    ...
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td>
                                <a data-toggle="tooltip" title="Edit" class="btn btn-success" href="{{url('/admin/email-templates/edit/'.$item->et_id)}}"><i class="fa fa-pencil"></i></a>
								<a data-toggle="tooltip" title="View" class="btn btn-success"href="{{url('/admin/email-templates/view/'.$item->et_id)}}"><i class="glyphicon glyphicon-eye-open"></i></a>
