...
@section('content')
    ...
    <div class="row">
                            ...
                            <div style="height: 140px;">
                                <div class="patientImage">
                                    @if(isset($items->photo) && (!empty($items->photo)))
                                        <img src="{{asset('public/images/practitioners/'.$items->photo)}}" alt="{{$items->photo}}" class="img-responsive" style="max-height: 90px;" />
                                    @else
        ...
        <div class="row" style="margin-top: 20px;">
            <div class="col-md-4">
                <div class="col-md-12 no-padding">
                    ...
                    <div id="payment-p" class="divColor">
                        ...
                        <div class="row" id="btn-paymetns" style="margin:15px 0;text-align: center">
            ...
            <div class="col-md-8">
                <div class="col-md-12 no-padding" style="background-color: #fff;padding:30px 0;">
                    <div id="2" class="centermenu">
                    ...
                    <div id="3" class="centermenu">
                        ...
                        <div  class="runtimemenu" style="display: none;">
                            ...
                            <div class="runtimesubmenu" onclick="location.href='{{URL::to('/practitioner/suggestion/supplement-suggestions-wizzard?pa_id=').$items->pa_id}}'">
                                Suggest
                            </div>
                    ...
                    <div id="7" class="centermenu">
                        ...
                        <div  class="runtimemenu" style="display: none;">
                            ...
                            <div class="runtimesubmenu" onclick="location.href='{{URL::to('/practitioner/suggestion/nutrition-suggestions-wizzard?pa_id=').$items->pa_id}}'">
                                Suggest
                            </div>
                            <div class="runtimesubmenu">
                                History
            ...
            <div class="col-md-8" style="margin-top: 20px;">
                <div class="col-md-12 no-padding" style="background-color: #fff;padding:30px 0;">
                    <div class="row" style="padding:0 20px;">
                        ...
                        <div class="col-md-12">@if(isset($notes->note_text) && (!empty($notes->note_text)))
                            {{$notes->note_text}}
                            @endif</div>
                    </div>
</div>            </div>
            ...
            <div class="col-md-8" style="margin-top: 20px;">
                <div class="col-md-12 no-padding" style="background-color: #fff;padding:30px 0;">
                    ...
                    <div class="row" style="margin-top: 20px;padding:0 20px;">
                        <div class="col-md-2" style="   border-right: 1px solid #d9d9d9;">TEST</div>
