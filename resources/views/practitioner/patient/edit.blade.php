...
<ol class="breadcrumb pull-right">
    ...
    <li><a href="{{url('/practitioner/patient/new')}}">Contact</a></li>
...
<div class="col-md-6 col-md-offset-3">
    <img src="{{asset('public/images/practitioners/'.$table1->photo)}}" alt="{{$table1->photo}}" class="img-responsive" style="max-height: 64px;" />
	<!--<img src="{{asset('public/images/'. $directory .'/'.$table1->photo)}}" alt="{{$table1->photo}}" class="img-responsive" style="max-height: 64px;" />-->
