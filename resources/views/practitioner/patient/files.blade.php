...
<ol class="breadcrumb pull-right">
    ...
    <li><a href="{{url('/practitioner/patient')}}">Contact</a></li>
     ...
     <div class="col-md-1">
                ...
                <div class="col-md-12">
                    <table id="data-table" class="table table-striped table-hover">
                        ...
                        <tbody>
                        <?php if(isset($table2) && (!empty($table2))) { ?>
@foreach($table2 as $items)
       <tr>

           <td>
           @if(isset($items->file_name) && (!empty($items->file_name)))
        {{$items->file_name}}
        @endif
           </td>

           <td>
               <a href="javascript:void(0);" onclick="window.location.href='{{url('/practitioner/patient/download-file/'.$items->pf_id)}}'"><i class="fa fa-download"></i> Download</a> |
               <a href="javascript:void(0);" onclick="doDelete('{{$items->pf_id}}', this);"><i class="fa fa-trash-o"></i> Remove</a>
