...
<a class="btn btn-success pull-right" href="{{url('practitioner/contact-group/new')}}" style="margin: 3px 12px;"><i class="fa fa-plus"></i> Add New Groups</a>
<!-- end breadcrumb -->
<!-- begin page-header -->
                ...
                <table id="data-table" class="table table-striped table-hover"> 
                    ...
                    @foreach($cg_list as $item)
                        <tr>
                            ...
                            <td>
                                <a data-toggle="tooltip" title="Edit" class="btn btn-success" href="{{url('/practitioner/contact-group/edit/'.$item->cg_id)}}"><i class="fa fa-pencil"></i></a> 
                                <a data-toggle="tooltip" title="Delete" class="btn btn-danger" href="javascript:void(0);" onclick="doDelete('{{$item->cg_id}}', this);"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
