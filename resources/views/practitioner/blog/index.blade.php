...
<a href="{{url('/practitioner/blog/new')}}" class="btn btn-success pull-right" style="margin-right: 15px;border-radius:0;"><i class="fa fa-plus"></i> Add Blog</a>
                    ...
                    @foreach($table1 as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a target="_blank" href="{{url('/practitioner/blog/show/'.$item->post_id)}}"><i class="fa fa-pencil"></i> View</a> |
