...
<a href="{{url('/practitioner/referral/addnewreferer')}}" class="btn btn-success pull-right" style="margin-right: 15px;border-radius:0;"><i class="fa fa-plus"></i> Add New Referrer</a>
<!-- end breadcrumb -->
<!-- begin page-header -->
<br>
