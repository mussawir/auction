...
<a href="{{url('/practitioner/email-templates/new')}}"  class="btn btn-success pull-right" style="margin-right: 15px;border-radius:0;"><i class="fa fa-plus"></i> Add New Template</a>
<!-- end breadcrumb -->
<!-- begin page-header -->
                ...
                <table id="data-table" class="table table-striped table-hover">
                    ...
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success" data-toggle="tooltip" title="View" href="{{url('/practitioner/email-templates/view/'.$item->et_id)}}"><i class="glyphicon glyphicon-eye-open"></i></a>
                                
                                <a class="btn btn-warning" data-toggle="tooltip" title="Edit" href="{{url('/practitioner/email-templates/edit/'.$item->et_id)}}"><i class="fa fa-pencil"></i></a>
