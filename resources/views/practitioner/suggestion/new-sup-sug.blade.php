    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-12" style="margin-bottom: 10px;">
                {{--{!! Form::submit('Select Contact(s) >>', array('class'=>'btn btn-success pull-right')) !!}--}}
                <button type="button" id="btn-next" class="btn btn-success pull-right">Select Contact(s) >></button>
            </div>
            </div>
            <div class="panel panel-primary" data-sortable-id="ui-widget-6" data-init="true">
                <div class="panel-heading">
