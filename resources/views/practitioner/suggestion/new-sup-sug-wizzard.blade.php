                    ...
                    <form action="{{URL::to('/practitioner/email-group/addPatients')}}" method="POST" data-parsley-validate="true" name="form-wizard" id="form-wizard">
                        <div id="wizard">
                            ...
                            <div class="wizard-step-1">
                                <fieldset>
                                    <legend class="pull-left width-full">Select supplements For Recommendation</legend>
                                </fieldset>
                                        ...
                                        <div>
                                            <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
                                                <div class="panel-heading">
                                                    ...
                                                    <h4 class="panel-title">Select supplements</h4>
                                                </div>
                                                <div class="panel-body">
...
$(this).attr('checked', false);
        ...
        function removeSupRow(elm, id) {
            ...
            $.get("{{url('/practitioner/suggestion/removeSelectedSup')}}", { sup_id: id }, function(data) {
                ...
                if(data == 'success') {
                    ...
                    uncheckBoxed('selected-table-sup','sup_id');
                }
        ...
        function removePatientRow(elm, id) {
            var obj = $(elm).closest('table').attr('id');
...
function addSuppementsList()
{
    ...
    $.ajax({
        type: "POST",
        data: form_data,
        url: '{{ URL::to('/practitioner/suggestion/add-sups-wizz') }}',
        ...
        success: function (result) {
            ...
            for(var i = 0;i<mainsplit.length;i++)
            {
                ...
                var imgPath = '{{asset('public/dashboard/img/sup-img/')}}';
...
$('#patient-btn-1').hide();
    ...
    $.ajax({
        type: "POST",
        data: form_data,
        url: '{{ URL::to('/practitioner/suggestion/add-patient-wizz') }}',
        beforeSend: function (request) {
            return request.setRequestHeader('X-CSRF-Token', $("meta[name='csrf-token']").attr('content'));
        },
        success: function (result) {
...
function saveGroup()
        {
            ...
            $.ajax({
                type: "POST",
                data: form_data,
                url: '{{ URL::to('/practitioner/suggestion/save-sup-wiz') }}',
                beforeSend: function (request) {
                    return request.setRequestHeader('X-CSRF-Token', $("meta[name='csrf-token']").attr('content'));
                },
                success: function (result) {
