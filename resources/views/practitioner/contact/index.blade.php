...
<a class="btn btn-success pull-right" href="{{url('/practitioner/contact/new')}}" style="margin: 3px 12px;"><i class="fa fa-plus"></i>  Add New Contact</a>
<!-- end breadcrumb -->
<!-- begin page-header -->
                        ...
                        <tr>
                            <td>
                                @if(isset($item->photo) && (!empty($item->photo)))
                                    <img src="{{asset('public/images/practitioners/'.$practitioner_info->url . '/' .$item->photo)}}" alt="photo" class="img-responsive" style="max-height: 64px;" />
                                @else
                            ...
                            <td>{{$item->address}}</td>
                            <td>
                                <a style="margin-bottom:2px;"class="btn btn-success" data-toggle="tooltip" title="Edit" href="{{url('/practitioner/contact/edit/'.$item->cnt_id)}}"  ><i class="fa fa-pencil"  ></i></a> 
                                <a class="btn btn-danger" data-toggle="tooltip" title="Delete" href="javascript:void(0);" onclick="doDelete('{{$item->cnt_id}}', this);"><i class="fa fa-trash-o"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
