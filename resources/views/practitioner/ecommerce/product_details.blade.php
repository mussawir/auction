                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="product-image">
                                            ...
                                            @foreach($images as $item)
                                                <li>
                                                    <a href="#" data-click="show-main-image" data-url="{{asset($item->image_path)}}">
                                                        <img src="{{asset($item->image_path)}}" onclick="$('#hero-main-image').attr('src',$(this).attr('src'));" alt=""/>
                                                    </a>
                                                </li>
                                            @endforeach
										<?php } ?>
                                    ...
                                    <div class="product-main-image" data-id="main-image">
                                        <img src="{{asset($product->mainImage)}}" id="hero-main-image" alt="" />
                                    </div>
									<?php } ?>
                            ...
                            <div class="col-md-6" style="padding: 20px 30px;margin-bottom: 20px;">
                                ...
                                <div class="product-info-header">
                                    <h1 class="product-title"><span class="label label-success">{{ $product->discountPer }} % OFF</span> {{ $product->products_name }} </h1>
                                ...
                                @else
                                    ...
                                    <ul class="product-info-list">
                                        <li><i class="fa fa-circle"></i><strong>Posted at:</strong> {{ $product->created_at }}</li>
                                        ...
                                        <li><i class="fa fa-circle"></i><strong>Supplier: </strong>{{ $product->first_name }} {{ $product->last_name }}</li>
                                    ...
                                    <div class="product-purchase-container">
                                        <div class="product-discount">
                                            <span class="discount">Original Price: ${{ $product->price }}</span>
                                        </div>
                                        <div class="product-price">
                                            <?php
                                            $selling = $product->price - ($product->price * ($product->discountPer / 100)) ?>
                                            <div class="price"> Discounted Price: ${{ round($selling) }}</div>
                                        </div>
                    ...
                    {{--<div class="col-md-6">--}}
                        ...
                        {{--@foreach($images as $image)--}}
                                {{--<div class="col-md-6" style="margin-bottom: 15px;">--}}
                                            {{--<img src="{{asset($image->image_path)}}" alt="Northern Lights, Norway" width="200" height="200">--}}
                                {{--</div>--}}
                        {{--@endforeach--}}
                    {{--</div>--}}
                    {{--<div class="col-md-6">--}}
                        {{--<h5><strong>Product Name:</strong> {{ $product->products_name }}</h5>--}}
                        {{--<h5><strong>Product Category:</strong> {{ $product->cat_name }}</h5>--}}
                        {{--<h5><strong>Product Price:</strong> ${{ $product->price }}</h5>--}}
                        {{--<h5><strong>Product Qunaity:</strong> {{ $product->quantity }}</h5>--}}
                        {{--<h5><strong>Product Tags:</strong> {{ $product->tags }}</h5>--}}
                        {{--<h5><strong>Product Tax Percentage</strong>: {{ $product->taxPer }}</h5>--}}
                        {{--<h5><strong>Product Tax Amount</strong>: {{ $product->taxAmount }}</h5>--}}
