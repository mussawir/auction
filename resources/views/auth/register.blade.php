            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                   ...
                   <div class="form-group{{ $errors->has('identity') ? ' has-error' : '' }}">
                            <label for="identity" class="col-md-4 control-label">Passport / Ic Numbers</label>
                        ...
                        <div class="form-group{{ $errors->has('campus_name') ? ' has-error' : '' }}">
                            <label for="campus_name" class="col-md-4 control-label">Campus Name </label>

                            <div class="col-md-6">
                                <input id="campus_name" type="campus_name" class="form-control" name="campus_name" value="{{ old('campus_name') }}" required>
