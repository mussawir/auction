...
<link href="{{ asset('public/plugins/bootstrap-wysihtml5/src/bootstrap-wysihtml5.css') }}" rel="stylesheet">   
   <!-- ================== END BASE CSS STYLE ================== -->
	...
	<link href="{{ asset('public/plugins/jstree/dist/themes/default/style.min.css') }}" rel="stylesheet" />
    ...
    <div id="header" class="header navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                <a href="{{url('/supplier')}}" class="navbar-brand"><span class="navbar-logo"></span> Practice Tabs</a>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown navbar-user">
                    ...
                    <ul class="dropdown-menu animated fadeInLeft">
                        ...
                        <li><a href="{{url('/supplier/index/change-password')}}">Change Password</a></li>
                        <li class="divider"></li>
        ...
        <div data-scrollbar="true" data-height="100%">
            ...
            <ul class="nav">
                <li class="nav-profile">
                    <div class="image">
                        <a href="javascript:;"><img src="{{url('public/img/user-13.jpg')}}" alt="" /></a>
                    </div>
                    <div class="info">
                        @if(Auth::check())
            ...
            <ul class="nav">
                ...
                <li class="has-sub <?php if(isset($pro_main_menu)) echo $pro_main_menu;?>">
                    <a href="{{url('/supplier/product/list')}}">
                ...
                <li class="has-sub <?php if(isset($tag_main_menu)) echo $tag_main_menu;?>">
                    ...
                    <ul class="sub-menu">
                        <li class="<?php if(isset($tag_new)) echo $tag_new;?>"><a href="{{url('/supplier/product/tags/new?flagType=TAG')}}">Add New / List</a></li>
                        <li class="<?php if(isset($pre_tag_list)) echo $pre_tag_list;?>"><a href="{{url('/supplier/product/tags/predefined?flagType=TAG')}}">Pre-defined</a></li>
                    </ul>
                </li>

                <li class="has-sub <?php if(isset($brand_main_menu)) echo $brand_main_menu;?>">
                    <a href="{{url('/supplier/product/brands/list')}}">
                        <span class="badge pull-right"></span>
                        <i class="fa fa-tag"></i>
                        <span>Brands</span>
                    </a>
				...
				<li class="has-sub <?php if(isset($orders_main_menu)) echo $orders_main_menu;?>">
                    ...
                    <!--<ul class="sub-menu">
                        <li class="<?php if(isset($order_list)) echo $order_list;?>"><a href="{{url('/supplier/orders/list')}}">All Orders</a></li>
						<li class="<?php if(isset($order_list_0)) echo $order_list_0;?>"><a href="{{url('/supplier/orders/list/0')}}">Pending</a></li>
						<li class="<?php if(isset($order_list_1)) echo $order_list_1;?>"><a href="{{url('/supplier/orders/list/1')}}">Delivered</a></li>
						<li class="<?php if(isset($order_list_2)) echo $order_list_2;?>"><a href="{{url('/supplier/orders/list/2')}}">Process</a></li>
						<li class="<?php if(isset($order_list_3)) echo $order_list_3;?>"><a href="{{url('/supplier/orders/list/3')}}">Cancelled</a></li>
                    </ul>-->
						<ul class="sub-menu">
                       <!-- <li class="<?php if(isset($order_list_)) echo $order_list_;?>"><a href="{{url('/supplier/orders/list')}}">All Orders</a></li>
						--><li class="<?php if(isset($order_list_0)) echo $order_list_0;?>"><a href="{{url('/supplier/orders/list/0')}}">New</a></li>
						<li class="<?php if(isset($order_list_2)) echo $order_list_2;?>"><a href="{{url('/supplier/orders/process/2')}}">Process</a></li>
						<!--<li class="<?php if(isset($order_list_4)) echo $order_list_4;?>"><a href="{{url('/supplier/orders/list/4')}}">Shipped</a></li>-->
...
<script type="text/javascript" src="{{asset('public/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/plugins/bootstrap-tagsinput/bootstrap-tagsinput-typeahead.js')}}"></script>
<script type="text/javascript" src="{{asset('public/plugins/jquery-tag-it/js/tag-it.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/plugins/select2/dist/js/select2.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/plugins/jstree/dist/jstree.min.js')}}"></script>
<!-- ================== END PAGE LEVEL JS ================== -->
@yield('bottom')
