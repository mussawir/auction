    ...
    <div id="header" class="header navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                <a href="{{url('/admin')}}" class="navbar-brand">Practice Tabs</a>
    ...
    <div id="sidebar" class="sidebar">
        ...
        <div data-scrollbar="true" data-height="100%">
            ...
            <ul class="nav">
                ...
                <li class="has-sub {{isset($meta['pro_list'])?$meta['pro_list']:''}}">
                    <a href="{{url('/admin/products')}}">
                        <i class="fa fa-list"></i>
                        <span>Products</span>
                    </a>
                <li>
                <li class="has-sub {{isset($meta['cat_main_menu'])?$meta['cat_main_menu']:''}}">
               ...
               <!-- <li class="has-sub {{isset($meta['nut_main_menu'])?$meta['nut_main_menu']:''}}">
                ...
                <li class="has-sub <?php if(isset($active_pra_menu))echo $active_pra_menu?>">
                    <a href="{{url('/admin/index/practitioners')}}">
                        <span class="badge pull-right"></span>
                        <i class="fa fa-user-md"></i>
                        <span>Practitioners</span>
                    </a>
                </li>
				<li class="has-sub <?php if(isset($meta['blog_main_menu']))echo $meta['blog_main_menu'];?>">
                    <a href="{{url('/admin/adminBlog')}}">
                        <span class="badge pull-right"></span>
                ...
                <li class="has-sub {{isset($meta['cm_main_menu'])?$meta['cm_main_menu']:''}}">
                    ...
                    <ul class="sub-menu">
                        <li class="{{isset($meta['cg_sub_menu_list'])?$meta['cg_sub_menu_list']:''}}"><a href="{{url('/admin/contact-group')}}">Group</a></li>
                        <li class="{{isset($meta['cnt_sub_menu_list'])?$meta['cnt_sub_menu_list']:''}}"><a href="{{url('/admin/contact')}}">Contact</a></li>
                    </ul>
                </li>
              ...
              <!--  <li class="has-sub <?php if(isset($user_menu))echo $user_menu?>">
                    <a href="{{url('/admin/index/users')}}">
                        <i class="fa fa-medkit"></i>
                        <span>Users</span>
                    </a>
                <li>-->
                <li class="has-sub {{isset($meta['supp_main_menu'])?$meta['supp_main_menu']:''}}">
                ...
                <li class="<?php if(isset($coupon_menu))echo $coupon_menu?>">
				...
				<li class="has-sub <?php if(isset($meta['order_main_menu'])) echo $meta['order_main_menu']; ?>">
                    <a href="#">
                        <span class="badge pull-right"></span>
					 ...
					 <ul class="sub-menu">
                        <li class="{{isset($meta['order_pt_profit'])?$meta['order_pt_profit']:''}}"><a href="{{url('/admin/orders')}}">PT Profit</a></li>
                    </ul>
				</li>
...
<!-- ================== END PAGE LEVEL JS ================== -->
@yield('bottom')
<script type="text/javascript" src="{{asset('public/js/apps.min.js')}}"></script>
