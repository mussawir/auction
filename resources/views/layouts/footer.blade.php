@section('footer')   
   <!-- BEGIN #footer -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="list-unstyled list-product">
                            <li>
                                <div class="image">
                                    <img src="{{asset('public/theme/img/iphone-6s.jpg')}}" alt="" />
                                </div>
                                <div class="info">
                            ...
                            <li>
                                <div class="image">
                                    <img src="{{asset('public/theme/img/galaxy-s6.jpg')}}" alt="" />
                                </div>
                                <div class="info">
                            ...
                            <li>
                                <div class="image">
                                    <img src="{{asset('public/theme/img/ipad-pro.jpg')}}" alt="" />
                                </div>
                                <div class="info">
                            ...
                            <li>
                                <div class="image">
                                    <img src="{{asset('public/theme/img/galaxy-note5.jpg')}}" alt="" />
                                </div>
                                <div class="info">
        ...
        <div id="footer-copyright" class="footer-copyright">
            ...
            <div class="container">
                <div class="payment-method">
                    <img src="{{asset('public/theme/img/payment_method.png')}}" alt="" />
                </div>
                <div class="copyright">
	...
	<!-- ================== BEGIN BASE JS ================== -->
	<script src="{{asset('public/theme/plugins/jquery/jquery-1.9.1.min.js')}}"></script>
	<script src="{{asset('public/theme/plugins/jquery/jquery-migrate-1.1.0.min.js')}}"></script>
	...
	<![endif]-->
	<script src="{{asset('public/theme/plugins/jquery-cookie/jquery.cookie.js')}}"></script>
	<script src="{{asset('public/theme/js/apps.min.js')}}"></script>
	<!-- ================== END BASE JS ================== -->
